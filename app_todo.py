...
def todo():
    ...
    TODO_ITEM_DESCRIPTION = "todoItemDescription"
    ...
    description = request.args.get(TODO_ITEM_DESCRIPTION)
    ...
    if api_method == CREATE_TODO_ITEM:
        response = todo_item_controller.create_todo_item(name, category, description, is_completed)

    elif api_method == GET_TODO_ITEMS:
        response = todo_item_controller.get_todo_items()

    elif api_method == UPDATE_TODO_ITEM:
        response = todo_item_controller.update_todo_item(item_id, name, category, description, is_completed)
    
    elif api_method == DELETE_TODO_ITEM:
        response = todo_item_controller.delete_todo_item(item_id)
